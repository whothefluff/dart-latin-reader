...
class _AdaptiveLayoutDelegate extends MultiChildLayoutDelegate {
  ...
  void performLayout(Size size) {
    ...
    final remainingWidth = size.width - rightMargin - leftMargin;
    final remainingHeight = size.height - bottomMargin - topMargin;
    final halfWidth = size.width / 2;
    final halfHeight = size.height / 2;
    final hingeWidth = hinge != null ? hinge!.right - hinge!.left : 0;
  ...
  @override
  bool shouldRelayout(_AdaptiveLayoutDelegate oldDelegate) => oldDelegate.slots != slots;
  //
}
